...
Focus     Kotlin · Jetpack Compose · Clean Architecture
Horizon   Long-term compounding mindset
...
| | |
|---|---|
| **Quality** | Readability is not a preference — it is a standard |
| **Architecture** | Structure before implementation, always |
| **Documentation** | Every repo ships with a README |
| **Consistency** | Small daily progress compounds |
...
| | |
|---|---|
| **Learning** | Kotlin · Jetpack Compose · Coroutines · Flow · Hilt |
| **Building** | Pet Project #1 — architecture phase |
| **Reading** | Android documentation · Clean Architecture (R. Martin) |
...
<img src="https://skillicons.dev/icons?i=kotlin,java,androidstudio,figma,firebase,git,github&theme=dark"/>
...
| **Async / DI** | Coroutines · Flow · Hilt |
| **Tooling** | Android Studio · Gradle (Kotlin DSL) · Git |

---

<details>
<summary>Architecture model</summary>
...
**Constraints applied on every project**

- No business logic in ViewModel — Use Cases own domain
- No framework imports in Domain — testable in isolation
- Repository behind interface — swappable, mockable
...
|---|---|---|
| **#1** | Kotlin · Compose · Room · MVVM | 🔵 In progress |
| **#2** | Kotlin · Retrofit · Hilt · Flow | ⬜ Planned |
| **#3** | Kotlin · Firebase · Clean Architecture | ⬜ Planned |
...
→  Advanced Flow · Hilt · Room at scale
○  Pet Project #1 — shipped to GitHub
...
&nbsp;
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0d1117?style=flat-square&logo=linkedin&logoColor=00b4d8)](https://linkedin.com/in/YOUR_PROFILE)
&nbsp;
